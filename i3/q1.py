...
#Get all the indices of the training set data
num_train = len(train_dataset)
indices = list(range(num_train))
split = 40000

#Generate subsets of 4 training batches and 1 validation batch for data loading
...
#Generate plot with loss as a function of training epoch
plt.figure()
plt.xlabel('Epoch')
plt.ylabel('Loss')
...
plt.legend(loc='best')
plt.savefig('3q1plot1')

#Generate plot with validation accuracy as a function of training epoch
plt.figure()
plt.xlabel('Epoch')
